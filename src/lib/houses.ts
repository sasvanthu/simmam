...
export const houses: House[] = [
  {
    ...
    about:
      "Reigning champions of SIMMAM 2025. Rudras strike with thunder — masters of stage, sport, and spirit.",
  ...
  },
  {
    ...
    about: "Born of fire. Agniyas ignite every stage with passion that refuses to fade.",
